...
#docker run -d --network spring-network -e MYSQL_ALLOW_EMPTY_PASSWORD=true mysql:latest
...
#docker run -d --network spring-network -p 8081:8081 -e SPRING_DATASOURCE_URL=jdbc:mysql://mysql-container:3306/customer?createDatabaseIfNotExist=true -e SPRING_DATASOURCE_USERNAME=root spring
